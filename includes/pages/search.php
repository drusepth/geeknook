...
?>
<p>
	<h3 class="title">Listed below are people that are interested in <strong><?php echo $topic; ?></strong>.</h3>
	<ul class="people_list">
		<?php
			...
			$query = "SELECT * FROM `users` WHERE `Interests` LIKE '%" . $topic . "%' ORDER BY `ID` DESC LIMIT $page, $range";
